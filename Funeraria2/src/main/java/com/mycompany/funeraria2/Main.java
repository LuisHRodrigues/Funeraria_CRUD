...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * } else {
         * System.out.
         * println("Erro no salvamento: Esse RG deve possuir entre 7 e 9 digitos.");
         * }
         ...
         * } else {
         * System.out.
         * println("Erro no salvamento: Esse CPF deve possuir exatamente 11 dígitos.");
         * }
         ...
         * return rgSemMascara.length() >= 7 && rgSemMascara.length() <= 9; // RG pode
         * ter entre 7 e 9 dígitos
         * }
         */
    }
}
